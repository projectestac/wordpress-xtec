...
class script_upgrade_reactor_options_https extends agora_script_base {
    ...
    public string $title = 'Corregeix enllaços http a https a reactor_options';
    public string $info = 'Edita el registre reactor_options i canvia els enllaços que comencen per http a https';
